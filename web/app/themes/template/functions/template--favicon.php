...
add_action('wp_head', function () {
   ?>
    ...
    <link rel="icon" href="<?php bloginfo(
       'url'
    ); ?>/app/favicons/favicon-32x32.png" type="image/png" sizes="32x32" />
    <link rel="icon" href="<?php bloginfo(
       'url'
    ); ?>/app/favicons/favicon-16x16.png" type="image/png" sizes="16x16" />

    <!-- launcher (Android/Chrome) -->
    <link rel="manifest" href="<?php bloginfo(
       'url'
    ); ?>/app/favicons/site.webmanifest">

    <link rel="mask-icon" href="<?php bloginfo(
       'url'
    ); ?>/app/favicons/safari-pinned-tab.svg" color="#76b82d">
