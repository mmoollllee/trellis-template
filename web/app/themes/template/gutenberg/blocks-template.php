...
$spalten = ['col-12', 'col-s-6', 'col-md-4', 'col-lg-3'];
...
<?php foreach ($blocks as $i):
  ...
  foreach ($bilder as $bild): ?>
       ...
       ? '<a href="' .
          ...
          ' öffnen">'
       : ''; ?>
					<img data-flickity-lazyload="<?php echo get_field('spalten') == 1
        ? $bild['sizes']['slider']
        : $bild['sizes']['thumbnail']; ?>" alt="<?php echo $bild[
   'title'
]; ?>" />
				<?php echo $link ? '</a>' : ''; ?>
			</figure>
...
<?php else:echo 'Block bearbeiten um Verlinkungen hinzuzufügen';endif;
?>
