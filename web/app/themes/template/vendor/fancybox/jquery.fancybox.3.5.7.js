   ...
   $.extend(FancyBox.prototype, {
      ...
      jumpTo: function (pos, duration) {
         ...
         if (isMoved) {
            ...
            prop =
               'fancybox-animated fancybox-fx-' + current.opts.transitionEffect
      ...
      revealContent: function (slide) {
         ...
         if (effect === 'zoom') {
            ...
            if (opacity == 'auto') {
               opacity =
                  Math.abs(
                     slide.width / slide.height - start.width / start.height,
                  ) > 0.1
            }
      ...
      close: function (e, d) {
         ...
         if (effect === 'zoom') {
            ...
            if (opacity == 'auto') {
               opacity =
                  Math.abs(
                     current.width / current.height - end.width / end.height,
                  ) > 0.1
            }
      ...
      $.each(media, function (providerName, providerOpts) {
         ...
         if (providerName === 'youtube') {
            url = url.replace(/&t=((\d+)m)?(\d+)s/, function (match, p1, m, s) {
               return (
                  '&start=' + ((m ? parseInt(m, 10) * 60 : 0) + parseInt(s, 10))
               )
            })
...
;(function (window, document, $) {
   ...
   $(function () {
      ...
      $(window).on('hashchange.fb', function () {
         ...
         $.each($('.fancybox-container').get().reverse(), function (
            index,
            value,
         ) {
