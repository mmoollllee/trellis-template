   ...
   !(function (a) {
      ...
      ;(a[o] && a[o].version > e) ||
         ...
         (a[o].prototype = {
            ...
            truncate: function () {
               ...
               return (
                  ...
                  this.$dot[t ? 'addClass' : 'removeClass'](d.truncated),
            ...
            watch: function () {
               ...
               'window' == this.opts.watch
                  ? s.on(n.resize + e.uniqueId, function (t) {
            ...
            _truncateToNode: function (t) {
               ...
               if (
                  ...
                  for (var e = 0; e < n.length; e++) {
                     a(i[e]).replaceWith(n[e]),
                        a(n[e]).append(this.opts.ellipsis)
                     var s = this._fits()
                     if ((a(this.opts.ellipsis, n[e]).remove(), !s)) {
                        if ('node' == this.opts.truncate && 1 < e)
                           return void a(n[e - 2]).remove()
                        break
                     }
                  }
                  ...
                  if (1 == r.nodeType) {
                     var h = a('<' + r.nodeName + ' />')
                     h.append(this.opts.ellipsis),
                        a(r).replaceWith(h),
                        this._fits()
                           ? h.replaceWith(r)
                           : (h.remove(), (r = n[Math.max(0, e - 1)]))
                  }
                  1 == r.nodeType
            ...
            _truncateToWord: function (t) {
               for (
                  ...
                  if (
                     ((r = o.slice(0, h).join(s)),
                     i.__setTextContent(e, i._addEllipsis(r)),
                     i._fits())
                  ) {
                     'letter' == i.opts.truncate &&
                        (i.__setTextContent(e, o.slice(0, h + 1).join(s)),
            ...
            _truncateToLetter: function (t) {
               for (
                  var e = this,
                     ...
                     s = i.length;
                  0 <= s &&
                  (!(n = i.slice(0, s).join('')).length ||
                     (e.__setTextContent(t, e._addEllipsis(n)), !e._fits()));
                  s--
               );
            },
            _fits: function () {
            ...
            _getOriginalContent: function () {
               var i = this
               return (
                  this.$dot.find('script, style').addClass(d.keep),
                  this.opts.keep &&
                     this.$dot.find(this.opts.keep).addClass(d.keep),
                  this.$dot
                     .find('*')
                     .not('.' + d.keep)
                     .add(this.$dot)
                     ...
                     .each(function () {
                        var t = this,
                           e = a(this)
                        if (3 == t.nodeType) {
                           if ('' == a.trim(i.__getTextContent(t))) {
                              if (
                                 e
                                    .parent()
                                    .is(
            ...
            _getMaxHeight: function () {
               ...
               for (
                  ...
                  if (
                     'px' ==
                     (e = window.getComputedStyle(this.$dot[0])[t[i]]).slice(-2)
                  ) {
                     e = parseFloat(e)
                     break
                  }
            ...
            __getTextContent: function (t) {
               for (
                  var e = ['nodeValue', 'textContent', 'innerText'], i = 0;
                  i < e.length;
                  i++
               )
            ...
            __setTextContent: function (t, e) {
               for (
                  var i = ['nodeValue', 'textContent', 'innerText'], n = 0;
                  n < i.length;
                  n++
               )
                  t[i[n]] = e
         ...
         (a.fn[o] = function (t) {
            return (
               i(),
               (t = a.extend(!0, {}, a[o].defaults, t)),
               this.each(function () {
                  a(this).data(o, new a[o](a(this), t)._api())
               })
            )
         }))
      function i() {
         ;(s = a(window)),
            ...
            (t = {}),
            (n = {}),
            a.each([d, t, n], function (t, n) {
               n.add = function (t) {
                  for (var e = 0, i = (t = t.split(' ')).length; e < i; e++)
                     n[t[e]] = n.ddd(t[e])
               }
            }),
            (d.ddd = function (t) {
